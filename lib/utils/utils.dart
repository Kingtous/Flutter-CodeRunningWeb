...
class Utils {
  ...
  static Future<SharedPreferences> getShardPreferences() async {
...
//  }
  ...
  static String regex_sms = r"\d{6}";
  static String smsKeyWords = "白日梦";

  static String getSmsCode(String body) {
    // TODO
    if (!body.contains(smsKeyWords)) {
      return null;
    }
    return RegExp(regex_sms).firstMatch(body).group(0);
  }

  static void fillWords(TextEditingController controller, String code) {
